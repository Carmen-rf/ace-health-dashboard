...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        st.markdown("<h1 style='text-align:center; color:#5B2C6F;'>🧠 ACE Health Impact Dashboard</h1>", unsafe_allow_html=True)
...
if check_password():
    ...
    st.markdown("""
    - 📊 **Dashboard** — All ACE analyses and health outcome findings
